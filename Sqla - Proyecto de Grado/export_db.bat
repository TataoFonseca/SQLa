...
docker exec -i sqla-db /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "TuPasswordSeguro123!" -C -Q "BACKUP DATABASE [sqla_sandbox] TO DISK = '/var/opt/mssql/data/sqla_sandbox_backup.bak' WITH FORMAT, INIT;"
if %errorlevel% neq 0 (
